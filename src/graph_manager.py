...
class ThreadSafeSnapManager:
    ...
    def add_node(self, node_id):
        ...
        self.lock.acquire()
        try:
            return self.manager.add_node(node_id)
        finally:
            self.lock.release()
    ...
    def delete_node(self, node_id):
        self.lock.acquire()
        try:
            return self.manager.delete_node(node_id)
        finally:
            self.lock.release()
    ...
    def add_edge(self, src_id, dest_id, EId=-1):
        self.lock.acquire()
        try:
            return self.manager.add_edge(src_id, dest_id, EId)
        finally:
            self.lock.release()
    ...
    def get_edges_between(self, node1, node2):
        self.lock.acquire()
        try:
            return self.manager.get_edges_between( node1, node2)
        finally:
            self.lock.release()
    ...
    def get_edge(self, EId):
        self.lock.acquire()
        try:
            return self.manager.get_edge(EId)
        finally:
            self.lock.release()
    ...
    def get_node_iterator(self):
        self.lock.acquire()
        try:
            return self.manager.get_node_iterator()
        finally:
            self.lock.release()
    ...
    def get_node_attributes(self, node_id):
        self.lock.acquire()
        try:
            return self.manager.get_node_attributes(node_id)
        finally:
            self.lock.release()
    ...
    def get_node_attribute(self, node_id, attr_name):
        self.lock.acquire()
        try:
            return self.manager.get_node_attribute(node_id, attr_name)
        finally:
            self.lock.release()
    ...
    def get_edge_attributes(self, EId):
        self.lock.acquire()
        try:
            return self.manager.get_edge_attributes(EId)
        finally:
            self.lock.release()
    ...
    def get_edge_attribute(self, EId, attr_name):
        self.lock.acquire()
        try:
            return self.manager.get_edge_attribute(EId, attr_name)
        finally:
            self.lock.release()
    ...
    def get_node_count(self):
        self.lock.acquire()
        try:
            return self.manager.get_node_count()
        finally:
            self.lock.release()
    ...
    def get_edge_count(self):
        self.lock.acquire()
        try:
            return self.manager.get_edge_count()
        finally:
            self.lock.release()
    ...
    def add_node_attr(self, node_id, name, value):
        self.lock.acquire()
        try:
            return self.manager.add_node_attr(node_id, name, value)
        finally:
            self.lock.release()
    ...
    def add_edge_attr(self, EId, name, value):
        self.lock.acquire()
        try:
            return self.manager.add_edge_attr(EId, name, value)
        finally:
            self.lock.release()
    ...
    def is_node(self, node_id):
        self.lock.acquire()
        try:
            return self.manager.is_node(node_id)
        finally:
            self.lock.release()
    ...
    def save_graph(self, file_path):
        self.lock.acquire()
        try:
            return self.manager.save_graph(file_path)
        finally:
            self.lock.release()
    ...
    def load_graph(self, file_path):
        self.lock.acquire()
        try:
            return self.manager.load_graph(file_path)
        finally:
            self.lock.release()
