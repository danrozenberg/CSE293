...
if __name__ == '__main__':
    ...
    output_file_path = "X:/output_graphs/poa_directors_and_managers_affiliation.graph"
    allowed_worker_ids = pickle.load(open("X:/output_stats/poa_directors_and_managers.p",'rb'))
